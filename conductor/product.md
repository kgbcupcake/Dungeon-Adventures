# Initial Concept
The primary subjects are victims of a 'Digital Singularity'—advanced players who seek a meta-fictional descent into a cursed, self-modifying codebase. This is a nihilistic dungeon crawler where the UI is an active, aggressive predator. The audience expects a 'Reality-Warping' terminal: 85x25 boundaries that act as a high-voltage containment fence, 50%+ density ASCII corruption that simulates hardware agony, and a color palette of 'Vein-Red' and 'Nuclear-Waste Green.' The goal is to make the subject feel like they have unearthed a forbidden, sentient artifact that is actively decomposing the terminal as they play. User-friendliness is a failure; absolute atmospheric hostility is the only metric of success.

# Product Vision

## Target Audience & Goals
- **Target Audience:** "Digital Singularity victims"—hardcore players who enjoy meta-narratives, ARGs (Alternate Reality Games), and challenging, unconventional gameplay. They are drawn to experiences that break the fourth wall and are intentionally hostile or mysterious.
- **User Goals:**
