...
- [ ] Task: Identify and isolate all code related to `ImGui.NET` and `ClickableTransparentOverlay`. Add comments marking them as deprecated and disable their execution paths.
