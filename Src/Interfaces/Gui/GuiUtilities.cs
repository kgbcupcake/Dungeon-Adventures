...
namespace DungeonAdventures.Src.Interfaces
{
	...
	private void RenderFullJsonEditor()
		...
		private void RenderInjectionStatus()
		{
			...
			ImGui.SetNextWindowPos(new Vector2(displaySize.X / 2 - 300, displaySize.Y / 2 - 200), ImGuiCond.FirstUseEver);
			ImGui.SetNextWindowSize(new Vector2(600, 450));

			if (ImGui.Begin("System Notification", ref _showInjectionPopup, ImGuiWindowFlags.NoResize))
			{
